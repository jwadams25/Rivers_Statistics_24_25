...
::: {style="color: black; background-color: white; padding: 15px; border: 5px solid #006CB3; border-radius: 5px;"}
2.  Copy the code you just wrote. Go to ChatGPT. Paste the code and then type, "I am new to learning how to write R. You are an expert data scientist, teacher, and mentor. Provide me with an explanation of what each line of this code does?" Hit Enter. In this space, summarize what you learned.
:::

::: {style="color: black; background-color: white; padding: 15px; border: 5px solid #006CB3; border-radius: 5px;"}
3.  Given the results in the table and bar graph you produced in part 1 of this tutorial, why might we not want to compare the NUMBER of people within each political ideology that responded for each level of immigration?
:::
...
immigration |>
  ...
  scale_fill_manual(values = c("APPLY's Color", "GUEST's Color", "Leave's Color","Not sure's color")) +
  theme_minimal()
```
