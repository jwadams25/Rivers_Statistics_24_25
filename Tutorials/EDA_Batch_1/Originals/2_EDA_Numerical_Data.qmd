...
::: {style="color: black; background-color: white; padding: 15px; border: 5px solid #FF585D; border-radius: 5px;"}
2.  Run the following code to get a glimpse of the data. This will show you the number of variables, the names of them, and the type of them. It may be a bit confusing as you will see the names of the ariables listed down the first column.
:::
...
::: {style="color: black; background-color: white; padding: 15px; border: 5px solid #FF585D; border-radius: 5px;"}
1.  Copy the code you wrote to create your first histogram and paste it into the gray section below question 3 of this section. The grey space has the label your first density curve.
:::
