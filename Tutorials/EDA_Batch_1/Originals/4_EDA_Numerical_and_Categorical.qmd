...
::: {style="color: black; background-color: white; padding: 15px; border: 5px solid #006CB3; border-radius: 5px;"}
3.  Write down a second question that would require you to explore one numerical variable and one categorical variable. ::: {style="color: black; background-color: white; padding: 15px; border: 5px solid #006CB3; border-radius: 5px;"}
...
::: {style="color: black; background-color: white; padding: 15px; border: 5px solid #FF585D; border-radius: 5px;"}
2.  Go back to second tutorial and copy the `summarise` function, paste it below the line that has select, and edit it to fit this example.
:::
...
::: {style="color: black; background-color: white; padding: 15px; border: 5px solid #FF585D; border-radius: 5px;"} 1. Replace `NAME_OF_DATA_FRAME` and `NUMERICAL_VARIABLE` in the code chunk below question 4 in this section.
...
::: {style="color: black; background-color: white; padding: 15px; border: 5px solid #FF585D; border-radius: 5px;"}
3.  In the code chunk below question 5, ch hange `CATEGORICAL_VARIABLE` , `NUMBER_OF_LEVELS`, and `BIN_WIDTH`
:::
